                            ...
                            <div className="space-y-6">
                                {employeeJobs.map((job: any) => {
                                    ...
                                    return (
                                        <motion.div
                                            key={job._id}
                                            className="p-6 rounded-xl shadow-md flex flex-col sm:flex-row justify-between items-start sm:items-center bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-700 transition-colors duration-200 cursor-pointer"
...
job.states === "published"
? "bg-green-600 text-white"
: "bg-yellow-400 text-black dark:bg-yellow-500 dark:text-black"
}`}
                                                >
                                                    {job.states[0].toUpperCase() + job.states.slice(1)}
                                                </span>
                                            </div>
                                        </motion.div>
                                    );
